...
import com.safero.fellsafe.Checkactivity;
...
public class Requestclass {
    ...
    public static void sendrequest(final Context context , String mytoken){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, map, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Toast.makeText(context,"Sent success" , Toast.LENGTH_LONG).show();
